...
Lind = np.loadtxt('/scratch/smontill/Simpkins/Double_Well/outside_data.txt')
...
ax2 = ax.twinx()
ax2.plot(np.NaN, np.NaN, ls= '--', label= 'Out. Cav.', c='black')
ax2.plot(np.NaN, np.NaN, ls= '-',label="In. Cav", c='black')
